...
class P115StrmHelperTest(_PluginBase):
    # 插件名称
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "p115strmhelpertest_"
    # 加载顺序
    plugin_order = 99
    # 可使用的用户级别
    auth_level = 1
    ...
    def get_api(self) -> List[Dict[str, Any]]:
        """
        BASE_URL: {server_url}/api/v1/plugin/P115StrmHelperTest/redirect_url?apikey={APIKEY}
        0. 查询 pickcode
