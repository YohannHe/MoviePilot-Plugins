...
class StrmUrlGetter:
    ...
    def get_strm_url(self, pickcode: str, file_name: str) -> str:
        ...
        strm_url = f"{configer.moviepilot_address.rstrip('/')}/api/v1/plugin/P115StrmHelperTest/redirect_url?apikey={settings.API_TOKEN}&pickcode={pickcode}"
    ...
    def get_share_strm_url(
        ...
        strm_url = f"{configer.moviepilot_address.rstrip('/')}/api/v1/plugin/P115StrmHelperTest/redirect_url?apikey={settings.API_TOKEN}&share_code={share_code}&receive_code={receive_code}&id={file_id}"
        if strm_url_format == "pickname":
            strm_url += f"&file_name={file_name}"
